Shader "Custom/TerrainLitSL"
{
		Properties
		{
			[NoScaleOffset] _MainTex("MainTex", 2DArray) = "white" {}
			[NoScaleOffset] _GridTex("GridTex", 2D) = "white" {}
		...
		SubShader
		{
			...
			TEXTURE2D(_GridTex); SAMPLER(sampler_GridTex); float4 _GridTex_TexelSize;
			...
			struct GraphVertexOutput
			{
				...
				float4 visibility				: TEXCOORD4;
				// Interpolators defined by graph
				float3 WorldSpacePosition : TEXCOORD5;
				float3 WorldSpaceNormal : TEXCOORD6;
				float3 WorldSpaceTangent : TEXCOORD7;
				float3 WorldSpaceBiTangent : TEXCOORD8;
				float3 WorldSpaceViewDirection : TEXCOORD9;
			...
			{
				float4 c = SAMPLE_TEXTURE2D_ARRAY(_MainTex, sampler_MainTex, IN.WorldSpacePosition.xz * 0.02, IN.terrain[index]);
				return c * (IN.VertexColor[index] * IN.visibility[index]);
			}

			float4 GetCellData(GraphVertexInput v, int index) {
