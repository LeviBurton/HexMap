...
public class HexGridChunk : MonoBehaviour {
    ...
    {
        //terrain.EnableWireframe(enabled);
        //rivers.EnableWireframe(enabled);
        //roads.EnableWireframe(enabled);
        waterShore.EnableWireframe(enabled);
        water.EnableWireframe(enabled);
    }
